        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="https://drive.google.com/file/d/1TA-p0jsxcwWRBL9INqWDksw5yHkaAH1b/view?usp=drivesdk"
          ...
          <div className="order-1 lg:order-2 flex justify-center animate-fade-in">
            <div className="relative">
              ...
              <div className="w-72 h-72 sm:w-96 sm:h-96 bg-gray-200 dark:bg-gray-700 rounded-3xl overflow-hidden relative transition-colors">
               <img src="https://lh3.googleusercontent.com/pw/AP1GczOJ9ZJPh1XRjuNY9yb7SMPlHcnT0FJLCFKHsyDsKgM-BQSzGIUZMXHs_nTvIJsQcc8ZCX2XLnGohmt7LVrG2puoPyIr7tJHvcKsenT3gYvog9fUBe4Hj_rA6h60iAme_k3Z1gBa-C_CH1ubSi5eshY=w1024-h1024-s-no-gm?authuser=0" alt="Praveen Kumar Goli - Full Stack Developer"/>
